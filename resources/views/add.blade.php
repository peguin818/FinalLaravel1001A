                ...
                <div class="col-md-12">
                    ...
                    <form method="POST" action="{{url('save')}}">
                        ...
                        <div class="md-3">
                            ...
                            <textarea name="detail" id="detail" class="form-control" placeholder="Enter Product Details here" {{old('')}}></textarea>
                            @error('detail')
                                <div class="alert alert-danger" role ="alert">
                                    {{$message}}
                                </div>
                        ...
                        <div class="md-3">
                            ...
                            <input type="text" class="form-control" name="producer" value="{{old('name')}}">
                            @error('producer')
                                <div class="alert alert-danger" role ="alert">
                                    {{$message}}
                                </div>
