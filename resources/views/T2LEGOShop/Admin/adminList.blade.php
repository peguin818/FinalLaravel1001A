...
<head>
    <meta charset="utf-8">
    <title>T2LEGOShop - Admin List</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div style="margin-left: 5%; float: left">
                                    <a href="{{url ('admin/adminAdd')}}" class="btn btn-success pull-right">Add New Admin</a>
                                </div>
                                <br><br>
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($data as $row)
                                            <tr>
                                                <td>{{$row->admID}}</td>
                                                <td>{{$row->admUsername}}</td>
                                                <td>{{$row->admPassword}}</td>
                                                <td>{{$row->admFirstName}}</td>
                                                <td>{{$row->admLastName}}</td>
                                                <td>{{$row->admTel}}</td>
                                                <td>
                                                    <a href="{{url('admin/adminEdit/' . $row->admID)}}" class="btn btn-primary">Edit</a>
                                                    <a href="{{url('admin/adminDelete/' . $row->admID)}}" class="btn btn-danger" onclick="return confirm('You are about to delete a Admin');">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
