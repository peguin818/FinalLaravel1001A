...
<head>
    <meta charset="utf-8">
    <title>T2LEGOShop - Admin Edit</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">{{ Session::get('adminLoginID') }}</h6>
                        <span>Admin</span>
                    </div>
                </div>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">{{ Session::get('adminLoginID') }}</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="{{ url('admin/adminUpdate') }}" method="post">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="id" id="id" value="{{ $data->admID }}" readonly >
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="username" id="username" value="{{ $data->admUsername }}" >
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="password" class="form-control" name="password" id="password" value="{{ $data->admPassword }}">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="firstName" id="firstName" value="{{ $data->admFirstName }}" >
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="lastName" id="lastName" value="{{ $data->admLastName }}" >
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="tel" class="form-control" name="telephone" id="telephone" value="{{ $data->admTel }}" >
